...
#limit_count.append(range(0,1,1))
#data_type.append('jaso')
#limit_count.append(range(0, 1, 1))
#data_type.append('word')
#limit_count.append(range(5, 5+1, 1))
#data_type.append('char')
#limit_count.append(range(60000, 60001, 20000))
#data_type.append('jaso')
#num_words.append(range(25, 68+1, 1))
#data_type.append('word')
...
def main(data_type = 'word', limit_count = 5, num_words = None):
    ...
    text = corpus.get_test_data(n_data = 99999999999999999999999)
    ...
    if num_words is None:
        print("{}\nlimit_count {}\n\tvocab {}/{}({:.5f})\n\ttext {}/{}({:.5f})\n\tvocab in testdata {} \n\tnum of lines {}\n\tvocab per line {}".format(data_type, limit_count, used_vocab, full_vocab, (used_vocab/full_vocab), count_used, count_full, (count_used/count_full), text_count, len(text), text_count / len(text)))
    else:
        print("{}\nnum_words {}\n\tvocab {}/{}({:.5f})\n\ttext {}/{}({:.5f})\n\tvocab in testdata {} \n\tnum of lines {}\n\tvocab per line {}".format(data_type, num_words, used_vocab, full_vocab, (used_vocab/full_vocab), count_used, count_full, (count_used/count_full), text_count, len(text), text_count / len(text)))
