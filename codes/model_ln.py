...
class RNNModel(nn.Module):
    ...
    def __init__(self, rnn_type, ntoken, nhid, nlayers, dropout=0.5, layerNorm = False, nbatch = None):
        ...
        if rnn_type in ['LSTM', 'GRU']:
            if layerNorm:
                self.rnn = getattr(nn, rnn_type)(nhid, nhid, nlayers, dropout=dropout, layerNorm = layerNorm)
            else:
    ...
    def forward(self, input, hidden):
        ...
        #decoded size : seq_len, batch, ntoken
